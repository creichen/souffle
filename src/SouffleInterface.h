...
public:
  ...
  virtual void runAll(std::string inputDirectory = ".", std::string outputDirectory = ".",
                      std::string tablePrefix = "", std::string internalDB = "") = 0;
     ...
     */
    virtual void loadAll(std::string inputDirectory = ".", std::string internalDB = "") = 0;
     ...
     * Souffle with the `-g` option.
     */
    virtual void printAll(std::string outputDirectory = ".", std::string internalDB = "") = 0;
